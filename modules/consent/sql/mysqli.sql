...
CREATE TABLE `consent_batches` (
  ...
  `bcc` longtext,
  `callback-url` varchar(255) NOT NULL DEFAULT '',
  `email-agreement-type` enum('Guardian','Clientel','Both') NOT NULL DEFAULT 'Both',
...
CREATE TABLE `consent_emails` (
  ...
  `email-target` enum('Batch','Guardian','Clientel','Webmaster','Unknown') NOT NULL DEFAULT 'Unknown',
